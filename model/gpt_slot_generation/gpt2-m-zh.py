...
r'''
    nohup python -m torch.distributed.launch --nproc_per_node=2 gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-m-1 --data_path data/gpt2-zh/storal_zh_posttrain.json --scheduler linear > traingpt2-zh.log 2>&1 &
    nohup python gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-chinese-cluecorpussmall --data_path data/gpt2-zh/storal_zh_posttrain.json --scheduler linear > traingpt2-zh.log 2>&1 &

    nohup python -m torch.distributed.launch --nproc_per_node=2 gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-m-1 --data_path data/gpt2-zh/storal_zh_posttrain_512.json --scheduler linear > storal_zh_s2m.log 2>&1 &
    nohup python -m torch.distributed.launch --nproc_per_node=2 gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-zh-10e --data_path data/gpt2-zh/storal_zh_s2m_512.json --scheduler linear > storal_zh_s2m.log 2>&1 &

    nohup python gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-zh-pt5 --data_path data/gpt2-zh/storal_zh_s2m.json --scheduler linear > traingpt2-zh.out 2>&1 &
    nohup python -m torch.distributed.launch --nproc_per_node=3 gpt2-m-zh.py --data_path data/gpt2-zh/storal_zh_posttrain.json --scheduler linear > traingpt2-zh2.log 2>&1 &

    nohup python gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-zh-pt5-1024 --data_path data/zh_moral2story/zh_moral2story.json --scheduler linear > traingpt2-zh.log 2>&1 &
    9.35
    nohup python -m torch.distributed.launch --nproc_per_node=2 gpt2-m-zh.py --pretrained --model_checkpoint ./runs/gpt2-zh-pt5-1024 --data_path data/gpt2-zh/storal_zh_s2m.json --scheduler linear > traingpt2-zh2.log 2>&1 &
...
from transformers import (OpenAIGPTLMHeadModel, OpenAIGPTConfig, GPT2LMHeadModel, GPT2Config,
                          WEIGHTS_NAME, CONFIG_NAME, AdamW, BertTokenizer,TFGPT2LMHeadModel)
